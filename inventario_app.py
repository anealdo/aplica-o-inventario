...
if uploaded_file:
    ...
    if st.button("Gerar Relatório"):
        # Usar cópia do sistema com saldos preservados
        df_sistema_com_saldo = df_sistema.copy()
        df_sistema_com_saldo["SaldoFisico"] = df_sistema_com_saldo["IdentProduto"].map(st.session_state.saldos_acumulados)
        df_sistema_com_saldo.dropna(subset=["SaldoFisico"], inplace=True)

        df_sistema_com_saldo["Divergencia"] = df_sistema_com_saldo["SaldoFisico"] - df_sistema_com_saldo["Quantidade"]

        df_divergente = df_sistema_com_saldo[df_sistema_com_saldo["Divergencia"] != 0][[
        ...
        df_sistema_com_saldo["Acuracidade"] = df_sistema_com_saldo.apply(
        ...
        acuracidade_geral = round(df_sistema_com_saldo["Acuracidade"].mean(), 2)
